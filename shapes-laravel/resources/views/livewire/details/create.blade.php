    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Detail</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input wire:model="height" type="text" class="form-control" id="height" placeholder="Height">
                        @error('height')
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="length" type="text" class="form-control" id="length" placeholder="Length">
                        @error('length')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input wire:model="width" type="text" class="form-control" id="width" placeholder="Width">
                        @error('width')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="filament_color_id" class="form-control">
                            ...
                            @foreach ($filament_color as $filament_color)
                                <option value="{{ $filament_color->id }}">{{ $filament_color->id }}</option>
                            @endforeach
                        </select>
