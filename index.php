...
<?php require 'layout/header.php'; ?>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/dragon.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="image/output-with-accuracy.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>Imprime</h5>
   ...
   <div class="container ">
        ...
        <div class="col-md-4 py-2">
        	...
        	<div class="card h-100 card-body shadow my-5">
        		<div class="row container">
        			<div class="col-3 p-3">
        			<img src="image/2.jpeg" class="imgzoom img-fluid|thumbnail rounded-top|rounded-end|rounded-bottom|rounded-start|rounded-circle|" alt="" style="width: 300px; height: 300px"> 
	        		</div>
	        		<div class="col-2 text-white">
        	...
        	<div class="card h-100 card-body shadow my-5">
        		<div class="row container">
        			<div class="col-3 p-3">
        			<img src="image/1.jpeg" class="imgzoom img-fluid|thumbnail rounded-top|rounded-end|rounded-bottom|rounded-start|rounded-circle|" alt="" style="width: 300px; height: 300px"> 
	        		</div>
	        		<div class="col-2 text-white">
	        			.
	        		</div>
