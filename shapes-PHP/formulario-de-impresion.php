...
<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Servicio de Impresión</p>
...
<div class="col-md-10 py-4 mx-auto">
  <center>
    <input type="submit" class="btn btn-primary shadow" name="submit" value="Solicitar">
  </center>
</div>
</form>
    </div>
